...
func (_m *Executor) Execute(command string, messageCodes ...string) *fm.Response {
	...
	var r0 *fm.Response
	if rf, ok := ret.Get(0).(func(string, ...string) *fm.Response); ok {
		r0 = rf(command, messageCodes...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*fm.Response)
		}
	}
...
func (_m *Executor) ExecuteFields(command string, v interface{}, messageCodes ...string) *fm.Response {
	_va := make([]interface{}, len(messageCodes))
	for _i := range messageCodes {
		_va[_i] = messageCodes[_i]
	}
	...
	var r0 *fm.Response
	if rf, ok := ret.Get(0).(func(string, interface{}, ...string) *fm.Response); ok {
